    ...
    <app-layout>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-gray-200 overflow-hidden shadow-xl sm:rounded-lg flex" style="min-height: 600px; max-height: 600px;">
                    <!-- Listagem de Contatos -->
                    <div class="w-3/12 bg-gray-500 bg-opacity-25 border-r border-gray-200 overflow-y-scroll">
                        <ul>
                            <li 
                                v-for="contato in contatos" :key="contato.id"
                                @click="() => {CarregaMensagens(contato.id)}"
                                :class="(contatoAtivo && contatoAtivo.id == contato.id) ? 'bg-gray-200' : ''"
                                class="p-6 text-lg text-gray-600 leading-7 font-semibold border-b border-gray-200 hover:bg-opacity-100 hover:cursor-pointer hover:bg-gray-200">
                    ...
                    <div class="w-9/12 flex flex-col justify-between">
                        ...
                        <!-- Formulário -->
                        <div v-if="contatoAtivo" class="w-full bg-gray-500 bg-opacity-25 p-6 border-t border-gray-200">
